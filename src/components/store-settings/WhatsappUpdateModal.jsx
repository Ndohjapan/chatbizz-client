...
import WhatsappInfo from "./sub-settings/WhatsappInfo";

const steps = [
  { name: "Step 1", href: "#", status: "current", num: 1 },
  { name: "Step 2", href: "#", status: "upcoming", num: 2 },
];
...
function WhatsappUpdateModal({ isModalOpen, toggleModal }) {
...
export default WhatsappUpdateModal;
